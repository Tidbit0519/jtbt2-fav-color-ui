...
export default {
   ...
   */
  axios: {
    baseURL: 'https://jtbt2-fav-color-dev.byu-oit-fullstack-trn.amazon.byu.edu', // (`${API_SERVER}`).replace(/\/?$/, '/'), // ensure trailing slash // TODO: If most of your API endpoints start from a common base, then change it here, or add it after API_SERVER, like `${API_SERVER}/foo`
    https: true
  },
  /*
